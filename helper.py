...
def fetch_medal_tally(df,year,country):
    medal_df = df.drop_duplicates(subset=['Team','NOC','Games','Year','City','Sport','City','Sport','Event','Medal'])
...
def medal_tally(df):
    medal_tally = df.drop_duplicates(subset=['Team','NOC','Games','Year','City','Sport','City','Sport','Event','Medal'])
...
def fetch_overall_analysis(df):
    ...
    return editions,hosts,sports,events,nations,athletes
...
def hosted_events_over_time(df):
