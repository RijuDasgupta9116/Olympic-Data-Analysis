...
df = preprocessor.proprocess(df,region_df)

st.sidebar.title('Olymic Analysis')
...
if user_menu == 'Medal Tally':
    ...
    if selected_year != 'Overall' and selected_country == 'Overall':
        st.title("Analysis in "+str(selected_year)+" Olympics")
    if selected_year == 'Overall' and selected_country != 'Overall':
        st.title("Overall Analysis in "+selected_country+" Olympics")
    if selected_year != 'Overall' and selected_country != 'Overall':
        st.title("Analysis in "+str(selected_year)+" Olympics in "+selected_country)
...
if user_menu == 'Overall Analysis':
    ...
    editions,hosts,sports,events,nations,athletes = helper.fetch_overall_analysis(df)
    ...
    events_over_time = helper.hosted_events_over_time(df)
    ...
    st.title('No. of Events over times(Every Sport)')
